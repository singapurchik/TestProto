...
namespace TestProto.Players
{
	public class PlayerCarInstaller : MonoInstaller
	{
		...
		[SerializeField] private PlayerCarRotator _rotator;
		...
		public override void InstallBindings()
		{
			...
			Container.BindInstance(_rotator).WhenInjectedIntoInstance(_mover);
		...
		private void FindDependencies()
		{
			...
			_rotator = GetComponentInChildren<PlayerCarRotator>(true);
